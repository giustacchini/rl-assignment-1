...
\section{Assignment 1: Reinforcement Learning}

\subsection{Question 1}

{\large Q1: ``Prove that the policy iteration algorithm converges to the optimal policy for a finite MDP with a finite action space for each state.``}

\subsection{Question 2}

{\large Q2: ``Prove that the Bellman optimality equation has a unique solution for a finite MDP with a bounded reward function.``}

\subsection{Question 3}

{\large Q3: ``Analyze the challenges of using linear function approximation in value-based reinforcement learning. Discuss the potential issues that may arise and propose methods to mitigate them``}
